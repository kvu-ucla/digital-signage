...
for (const loc of LOCATIONS) {
  test.describe(`horizontal screen — ${loc.displayName}`, () => {
    const BASE_URL = `/?location=${loc.key}&screen=horizontal&menu=lunch&station=${encodeURIComponent(loc.station)}&mock=true`;
